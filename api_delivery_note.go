...
func (a *DeliveryNoteApiService) AddDeliveryNote(ctx context.Context, deliveryNotes DeliveryNoteInput) (DeliveryNote, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/delivery_notes"
	...
	// body params
	localVarPostBody = &deliveryNotes
	if ctx != nil {
...
/* 
DeliveryNoteApiService Find Delivery note by ID
...
func (a *DeliveryNoteApiService) FindDeliveryNoteById(ctx context.Context, id int64) (DeliveryNote, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/delivery_notes/{id}"
...
/* 
DeliveryNoteApiService All delivery note
Returns all delivery note from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindDeliveryNotesOpts - Optional Parameters:
