...
func (a *StockSupplierApiService) AddStockSupplier(ctx context.Context, stockSuppliers StockSupplierInput) (StockSupplier, *http.Response, error) {
	var (
		...
		localVarReturnValue StockSupplier
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/stock_suppliers"
	...
	// body params
	localVarPostBody = &stockSuppliers
	if ctx != nil {
...
/* 
StockSupplierApiService Find Stock supplier by ID
...
func (a *StockSupplierApiService) FindStockSupplierById(ctx context.Context, id int64) (StockSupplier, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/stock_suppliers/{id}"
...
/* 
StockSupplierApiService All stock supplier
Returns all stock supplier from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindStockSuppliersOpts - Optional Parameters:
