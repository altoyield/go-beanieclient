...
func (a *SalesInvoiceApiService) AddSalesInvoice(ctx context.Context, salesInvoices SalesInvoiceInput) (SalesInvoice, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/sales_invoices"
	...
	// body params
	localVarPostBody = &salesInvoices
	if ctx != nil {
...
/* 
SalesInvoiceApiService Find Sales invoice by ID
...
func (a *SalesInvoiceApiService) FindSalesInvoiceById(ctx context.Context, id int64) (SalesInvoice, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sales_invoices/{id}"
...
/* 
SalesInvoiceApiService All sales invoice
Returns all sales invoice from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindSalesInvoicesOpts - Optional Parameters:
