...
func (a *BillOfMaterialsApiService) AddBillOfMaterial(ctx context.Context, billOfMaterials BillOfMaterialInput) (BillOfMaterial, *http.Response, error) {
	var (
		...
		localVarReturnValue BillOfMaterial
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/bill_of_materials"
	...
	// body params
	localVarPostBody = &billOfMaterials
	if ctx != nil {
...
/* 
BillOfMaterialsApiService Find Bill of Materials by ID
...
func (a *BillOfMaterialsApiService) FindBillOfMaterialById(ctx context.Context, id int64) (BillOfMaterial, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/bill_of_materials/{id}"
...
/* 
BillOfMaterialsApiService All bill of materials
Returns all bill of materials from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindBillOfMaterialsOpts - Optional Parameters:
