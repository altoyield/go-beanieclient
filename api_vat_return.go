...
func (a *VatReturnApiService) AddVatReturn(ctx context.Context, vatReturns VatReturnInput) (VatReturn, *http.Response, error) {
	var (
		...
		localVarReturnValue VatReturn
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vat_returns"
...
/* 
VatReturnApiService Find VAT return by ID
...
func (a *VatReturnApiService) FindVatReturnById(ctx context.Context, id int64) (VatReturn, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vat_returns/{id}"
...
/* 
VatReturnApiService All vat return
Returns all vat return from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindVatReturnsOpts - Optional Parameters:
