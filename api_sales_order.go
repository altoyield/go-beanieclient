...
func (a *SalesOrderApiService) AddSalesOrder(ctx context.Context, salesOrders SalesOrderInput) (SalesOrder, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/sales_orders"
...
/* 
SalesOrderApiService All sales order
Returns all sales order from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindSalesOrderOpts - Optional Parameters:
...
/* 
SalesOrderApiService Find Sales order by ID
...
func (a *SalesOrderApiService) FindSalesOrderById(ctx context.Context, id int64) (SalesOrder, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sales_orders/{id}"
