...
func (a *NominalAccountCategoryApiService) AddNominalAccountCategory(ctx context.Context, nominalAccountCategories NominalAccountCategoryInput) (NominalAccountCategory, *http.Response, error) {
	var (
		...
		localVarReturnValue NominalAccountCategory
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/nominal_account_categories"
	...
	// body params
	localVarPostBody = &nominalAccountCategories
	if ctx != nil {
...
/* 
NominalAccountCategoryApiService All nominal account category
Returns all nominal account category from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindNominalAccountCategoriesOpts - Optional Parameters:
...
/* 
NominalAccountCategoryApiService Find Nominal account category by ID
...
func (a *NominalAccountCategoryApiService) FindNominalAccountCategoryById(ctx context.Context, id int64) (NominalAccountCategory, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/nominal_account_categories/{id}"
