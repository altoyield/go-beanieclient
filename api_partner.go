...
func (a *PartnerApiService) AddPartner(ctx context.Context, partners PartnerInput) (Partner, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/partners"
...
/* 
PartnerApiService Find Partner by ID
...
func (a *PartnerApiService) FindPartnerById(ctx context.Context, id int64) (Customer, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/partners/{id}"
...
/* 
PartnerApiService All partners
Returns all partners from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindPartnersOpts - Optional Parameters:
