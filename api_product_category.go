...
func (a *ProductCategoryApiService) AddProductCategory(ctx context.Context, productCategories ProductCategoryInput) (ProductCategory, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/product_categories"
	...
	// body params
	localVarPostBody = &productCategories
	if ctx != nil {
...
/* 
ProductCategoryApiService All product category
Returns all product category from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindProductCategoriesOpts - Optional Parameters:
...
/* 
ProductCategoryApiService Find Product category by ID
...
func (a *ProductCategoryApiService) FindProductCategoryById(ctx context.Context, id int64) (ProductCategory, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/product_categories/{id}"
