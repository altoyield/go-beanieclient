...
func (a *StockItemApiService) AddStockItem(ctx context.Context, stockItems StockItemInput) (StockItem, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/stock_items"
...
/* 
StockItemApiService Find Stock item by ID
...
func (a *StockItemApiService) FindStockItemById(ctx context.Context, id int64) (StockItem, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/stock_items/{id}"
...
/* 
StockItemApiService All stock item
Returns all stock item from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindStockItemsOpts - Optional Parameters:
