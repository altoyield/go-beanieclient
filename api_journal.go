...
/* 
JournalApiService Find Journal by ID
...
func (a *JournalApiService) FindJournalById(ctx context.Context, id int64) (Journal, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/journals/{id}"
...
/* 
JournalApiService All journal
Returns all journal from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindJournalsOpts - Optional Parameters:
