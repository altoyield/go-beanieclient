...
func (a *FixedAssetApiService) AddFixedAsset(ctx context.Context, fixedAssets FixedAssetInput) (FixedAsset, *http.Response, error) {
	var (
		...
		localVarReturnValue FixedAsset
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/fixed_assets"
...
/* 
FixedAssetApiService Find Fixed asset by ID
...
func (a *FixedAssetApiService) FindFixedAssetById(ctx context.Context, id int64) (FixedAsset, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/fixed_assets/{id}"
...
/* 
FixedAssetApiService All fixed asset
Returns all fixed asset from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindFixedAssetsOpts - Optional Parameters:
