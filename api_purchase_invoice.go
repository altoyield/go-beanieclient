...
func (a *PurchaseInvoiceApiService) AddPurchaseInvoice(ctx context.Context, purchaseInvoices PurchaseInvoiceInput) (PurchaseInvoice, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/purchase_invoices"
	...
	// body params
	localVarPostBody = &purchaseInvoices
	if ctx != nil {
...
/* 
PurchaseInvoiceApiService Find Purchase invoice by ID
...
func (a *PurchaseInvoiceApiService) FindPurchaseInvoiceById(ctx context.Context, id int64) (PurchaseInvoice, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/purchase_invoices/{id}"
...
/* 
PurchaseInvoiceApiService All purchase invoice
Returns all purchase invoice from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindPurchaseInvoicesOpts - Optional Parameters:
