...
func (a *ProductPriceApiService) AddProductPrice(ctx context.Context, productPrices ProductPriceInput) (ProductPrice, *http.Response, error) {
	var (
		...
		localVarReturnValue ProductPrice
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/product_prices"
	...
	// body params
	localVarPostBody = &productPrices
	if ctx != nil {
...
/* 
ProductPriceApiService Find Product price by ID
...
func (a *ProductPriceApiService) FindProductPriceById(ctx context.Context, id int64) (ProductPrice, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/product_prices/{id}"
...
/* 
ProductPriceApiService All product price
Returns all product price from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindProductPricesOpts - Optional Parameters:
