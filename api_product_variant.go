...
func (a *ProductVariantApiService) AddProductVariant(ctx context.Context, productVariants ProductVariantInput) (ProductVariant, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/product_variants"
	...
	// body params
	localVarPostBody = &productVariants
	if ctx != nil {
...
/* 
ProductVariantApiService Find Product variant by ID
...
func (a *ProductVariantApiService) FindProductVariantById(ctx context.Context, id int64) (ProductVariant, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/product_variants/{id}"
...
/* 
ProductVariantApiService All product variant
Returns all product variant from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindProductVariantsOpts - Optional Parameters:
