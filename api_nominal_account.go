...
func (a *NominalAccountApiService) AddNominalAccount(ctx context.Context, nominalAccounts NominalAccountInput) (NominalAccount, *http.Response, error) {
	var (
		...
		localVarReturnValue NominalAccount
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/nominal_accounts"
	...
	// body params
	localVarPostBody = &nominalAccounts
	if ctx != nil {
...
/* 
NominalAccountApiService Find Nominal account by ID
...
func (a *NominalAccountApiService) FindNominalAccountById(ctx context.Context, id int64) (NominalAccount, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/nominal_accounts/{id}"
...
/* 
NominalAccountApiService All nominal account
Returns all nominal account from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindNominalAccountsOpts - Optional Parameters:
