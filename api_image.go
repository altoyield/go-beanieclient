...
/* 
ImageApiService Find Image by ID
...
func (a *ImageApiService) FindImageById(ctx context.Context, id int64) (Image, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/images/{id}"
...
/* 
ImageApiService All image
Returns all image from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindImagesOpts - Optional Parameters:
