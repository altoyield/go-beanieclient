...
func (a *AddressBlockApiService) AddAddressBlock(ctx context.Context, addressBlocks AddressBlockInput) (AddressBlock, *http.Response, error) {
	var (
		...
		localVarReturnValue AddressBlock
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/address_blocks"
	...
	// body params
	localVarPostBody = &addressBlocks
	if ctx != nil {
...
/* 
AddressBlockApiService Find Address block by ID
...
func (a *AddressBlockApiService) FindAddressBlockById(ctx context.Context, id int64) (AddressBlock, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/address_blocks/{id}"
...
/* 
AddressBlockApiService All address block
Returns all address block from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindAddressBlocksOpts - Optional Parameters:
