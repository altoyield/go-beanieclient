...
func (a *VatRecordApiService) AddVatRecord(ctx context.Context, vatRecords VatRecordInput) (VatRecord, *http.Response, error) {
	var (
		...
		localVarReturnValue VatRecord
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vat_records"
...
/* 
VatRecordApiService Find VAT record by ID
...
func (a *VatRecordApiService) FindVatRecordById(ctx context.Context, id int64) (VatRecord, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vat_records/{id}"
...
/* 
VatRecordApiService All vat record
Returns all vat record from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindVatRecordsOpts - Optional Parameters:
