...
func (a *BeanieTaskApiService) AddBeanieTask(ctx context.Context, beanieTasks BeanieTaskInput) (BeanieTask, *http.Response, error) {
	var (
		...
		localVarReturnValue BeanieTask
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/beanie_tasks"
...
/* 
BeanieTaskApiService Find Beanie task by ID
...
func (a *BeanieTaskApiService) FindBeanieTaskById(ctx context.Context, id int64) (BeanieTask, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/beanie_tasks/{id}"
...
/* 
BeanieTaskApiService All beanie task
Returns all beanie task from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindBeanieTasksOpts - Optional Parameters:
