...
func (a *PurchaseOrderApiService) AddPurchaseOrder(ctx context.Context, purchaseOrders PurchaseOrderInput) (PurchaseOrder, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/purchase_orders"
...
/* 
PurchaseOrderApiService Find Purchase order by ID
...
func (a *PurchaseOrderApiService) FindPurchaseOrderById(ctx context.Context, id int64) (PurchaseOrder, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/purchase_orders/{id}"
...
/* 
PurchaseOrderApiService All purchase order
Returns all purchase order from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindPurchaseOrdersOpts - Optional Parameters:
