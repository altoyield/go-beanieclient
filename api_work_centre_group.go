...
/* 
WorkCentreGroupApiService Find Work centre group by ID
...
func (a *WorkCentreGroupApiService) FindWorkCentreGroupById(ctx context.Context, id int64) (WorkCentreGroup, *http.Response, error) {
	var (
		...
		localVarReturnValue WorkCentreGroup
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/work_centre_groups/{id}"
...
/* 
WorkCentreGroupApiService All work centre group
Returns all work centre group from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindWorkCentreGroupsOpts - Optional Parameters:
...
func (a *WorkCentreGroupApiService) FindWorkCentreGroups(ctx context.Context, localVarOptionals *FindWorkCentreGroupsOpts) ([]WorkCentreGroup, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/work_centre_groups"
