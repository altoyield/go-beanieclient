...
func (a *PartnerAddressApiService) AddPartnerAddress(ctx context.Context, partnerAddresses PartnerAddressInput) (PartnerAddress, *http.Response, error) {
	var (
		...
		localVarReturnValue PartnerAddress
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/partner_addresses"
	...
	// body params
	localVarPostBody = &partnerAddresses
	if ctx != nil {
...
/* 
PartnerAddressApiService Find Partner address by ID
...
func (a *PartnerAddressApiService) FindPartnerAddressById(ctx context.Context, id int64) (PartnerAddress, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/partner_addresses/{id}"
...
/* 
PartnerAddressApiService All partner address
Returns all partner address from the system that the user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FindPartnerAddressesOpts - Optional Parameters:
